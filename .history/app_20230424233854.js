...
`;
    ...
    serviceImgCover.addEventListener("mousemove", function (e) {
        ...
        let spaceX = (serviceImgWidth / 2 - serviceWrapperWidth) * 4;
        let spaceY = (serviceImgHeight / 2 - serviceWrapperHeight) * 4;
        let ratioX = serviceImgWidth / serviceImgWidth / 2;
        let ratioY = serviceImgHeight / serviceImgHeight / 2;
        let x = (pX - serviceImg.offsetLeft) * ratioX - spaceX;
        let y = (pY - serviceImg.offsetTop) * ratioY + spaceY;
