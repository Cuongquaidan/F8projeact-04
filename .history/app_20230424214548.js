...
`;
    ...
    serviceImgCover.addEventListener("mousemove", function (e) {
        ...
        console.log(ratioX);
        const spaceX = 740 + serviceImg.offsetWidth/2 - serviceImgCover.offsetWidth/2;
        const spaceY =
        let x = pX * ratioX;
        let y = pY * ratioY;
        serviceImg.style = `left : ${x}px;top:${y}px;max-height:unset;max-width:unset;width:auto;height:auto`;
    });
});
