...
`;
    ...
    serviceImgCover.addEventListener("mousemove", function (e) {
        ...
        serviceImgWidth = serviceImgWidth;
        serviceImgHeight = serviceImgHeight;
        let ratioX = serviceImgWidth / serviceImgWidth;
        let ratioY = serviceImgHeight / serviceImgHeight;
        let x = pX * ratioX + spaceX;
        let y = pY * ratioY + spaceY;
        serviceImg.style = `left: ${-x}px; top: ${-y}px; width: auto; height: auto; max-height: unset; transform: none;`;
    });
});
