...
`;
    ...
    const serviceImgWrapper = this.document.querySelector(".col__img-wrap");
    serviceImgCover.addEventListener("mousemove", function (e) {
        ...
        let spaceX = (serviceImgWidth / 2 - serviceImgWrapper) * 2;
        let spaceY = (serviceImgHeight / 2 - imageWraperHeight) * 2;
