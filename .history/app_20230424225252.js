...
`;
    ...
    serviceImgCover.addEventListener("mousemove", function (e) {
        const pX = e.clientuyX;
        const pY = e.clientuyY;
        ...
        let ratioX = serviceImgWidth / serviceImgWrapper / 2;
        let ratioY = serviceImgHeight / serviceImgHeight / 2;
        let x = (pX - serviceImgWrapper.offsetLeft) * ratioX;
        let y = (pY - serviceImgWrapper.offsetTop) * ratioY;
