...
function clicktab(event) {
    if (event.target.matches(".tab-title")) {
        ...
        shortLine.style.left = `${left - offSetLeft - 35}px`;
        shortLine.style.width = `${width + 50}px`;
        // const tabNum = event.target.dataset.tab;
        // tabContent.forEach(function (item) {
        //     return item.classList.remove("tab-content--active");
        // });
    }
}
